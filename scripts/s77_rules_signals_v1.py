...
def main():
    ...
    ap.add_argument(
        ...
        type=int,
        default=None,
        help="30m EMA base length in bars (overrides JSON).",
    )
    ...
    for pq in parqs:
        ...
        try:
            ...
            # --- Vermeulen-simple fields from today's daily row (if present) ---
            ...
            if len(dlast) >= 1:
                ...
                # daily booleans (already suffixed with _d by s00)
            ...
            rows.append({
                ...
                "trend_start_today_d": trend_start_today,     # one-time pulse
                "trend_active_above_d": trend_active_above,   # True while >= EMA20
                "trend_active_ge2_d": trend_active_ge2,       # True from day 2 onward
                "trend_cancelled_d": trend_cancelled,         # True when close < EMA20
                "pullback_entry_d": pullback_entry_now,        # conservative pullback entry
