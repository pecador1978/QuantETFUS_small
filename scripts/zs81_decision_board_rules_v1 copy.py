...
<section class="defs">
  ...
  <h3>ADX</h3>
  <ul>
    <li><b>ADX</b>: measures trend strength (no direction)</li>
    <li><b>+DI / −DI</b>: which side is stronger (up vs down)</li>
    <li><code>adx_long_guard</code>: ADX too weak for long</li>
    <li><code>adx_short_guard</code>: ADX too weak for short</li>
    <li><code>adx_long_not_rising</code>: ADX not rising enough (long)</li>
    <li><code>adx_short_not_rising</code>: ADX not rising enough (short)</li>
  </ul>
</div>
    <div class="box">
