...
"""
s81_decision_board.py — Operator-facing HTML dashboard for Gate-1 (JSON-driven s77, label-aware).
...
# ----------------- HTML builder -----------------
def build_html(df: pd.DataFrame, updated_label: str, label: str) -> str:
    style = """
<style>
:root{
...
/* Smart Money colors */
.sm-acc{color:#3b82f6}     /* Accumulation = blue */
.sm-dist{color:#f59e0b}    /* Distribution = orange */
...
/* RSI highlight */
.rsi-hot{color:#ef4444;font-weight:700}  /* >= 70 */
.rsi-cold{color:#3b82f6;font-weight:700} /* <= 30 */
...
(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    head = (
        ...
        "<th>RSI</th><th>REASON (LONG)</th><th>REASON (SHORT)</th>"
        "</tr></thead><tbody>"
    )
...
<section class="defs">
  ...
  <div class="grid">
    ...
    <div class="box">
      ...
      <ul>
        <li><b>Upper</b>: highest high of the last <code>N</code> days (ex-today)</li>
        <li><b>Lower</b>: lowest low of the last <code>N</code> days (ex-today)</li>
        <li><b>Width %</b>: (Upper / Lower − 1) × 100</li>
        <li><b>Position %</b>: (Close − Lower) / (Upper − Lower)</li>
        <li><b>Tokens</b>:
          <ul>
            <li><code>donchian_width_thin</code>: width % &lt; min</li>
            <li><code>donchian_long_extreme</code>: position % &gt; long cap</li>
            <li><code>donchian_short_extreme</code>: position % &lt; short cap</li>
            <li><code>donchian_breakout_long</code>: Close ≤ Upper when breakout required</li>
            <li><code>donchian_breakout_short</code>: Close ≥ Lower when breakout required</li>
          </ul>
        </li>
      </ul>
    </div>
...
def main():
    import argparse
    ap = argparse.ArgumentParser(description="s81 — label-aware dashboard for s77 rule signals, with localhost server.")
    ap.add_argument("--label", type=str, default="gate1_v1.0",
                    help="Which s77 label to render (e.g., gate1_1.0, gate1_strict, ...).")
    ...
    html = build_html(df, updated_label, label=label)
